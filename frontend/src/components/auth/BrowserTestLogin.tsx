...
const BrowserTestLogin: React.FC = () => {
  ...
  const handleTestLogin = async () => {
    ...
    try {
      ...
      setTestResult('SUCCESS: Login worked correctly!');
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', maxWidth: '500px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <button 
          ...
          style={{ padding: '10px 20px', marginRight: '10px', backgroundColor: '#28a745', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer' }}
        >
          Go to Dashboard
        </button>
