...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Error is handled by the Redux store, no need to set it locally
    }
  };
            ...
            <div className="flex w-full flex-col gap-8">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-base font-normal leading-normal text-gray-500 dark:text-gray-400">
                  Log in to your Globepay account
                </p>
              </div>
              ...
              <form className="flex w-full flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex w-full justify-end">
                    <a
                      className="cursor-pointer pt-2 text-sm font-medium leading-normal text-primary hover:underline"
                      href="#"
                    >
                      Forgot Password?
                    </a>
