...
export const currencyService = {
   ...
   */
  async convertCurrency(fromCurrency: string, toCurrency: string, amount: number): Promise<CurrencyConversion> {
    try {
      ...
      if (!(toCurrency in rates.rates)) {
        console.error(`Currency ${toCurrency} not found in rates. Available currencies:`, Object.keys(rates.rates));
