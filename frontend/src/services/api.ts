...
export const userApi = {
  ...
  updateUserPreferences: async (token: string, preferences: any) => {
    return apiRequest('/v1/user/preferences', {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${token}`,
...
export const transferApi = {
  getTransfers: async (token: string, page: number = 1, limit: number = 10) => {
  ...
  createTransfer: async (token: string, transferData: any) => {
...
export const beneficiaryApi = {
  ...
  createBeneficiary: async (token: string, beneficiaryData: any) => {
    return apiRequest('/v1/beneficiaries', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
  ...
  updateBeneficiary: async (token: string, beneficiaryId: string, beneficiaryData: any) => {
