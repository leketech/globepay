...
import RecipientForm, { RecipientFormData } from '../components/recipient/RecipientForm';
...
const Recipients: React.FC = () => {
  ...
  const handleSaveNewRecipient = (recipientData: RecipientFormData) => {
  ...
  const handleUpdateRecipient = (recipientData: RecipientFormData) => {
    setRecipients(
    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col gap-4 mb-8">
          <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] text-[#111618] dark:text-white">
            Manage Recipients
          </h1>
          <p className="text-base font-normal leading-normal text-gray-500 dark:text-gray-400">
            Add, edit, or delete your saved recipients.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {filteredRecipients.map((recipient) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center">
                    <span className="text-primary font-medium">{recipient.name.charAt(0)}</span>
                  </div>
                  <div className="flex-grow">
                    <p className="text-base font-semibold leading-normal line-clamp-1 text-[#111618] dark:text-white">
                      {recipient.name}
                    </p>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-background-dark rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8">
            {showAddForm ? (
              <RecipientForm onSubmit={handleSaveNewRecipient} onCancel={handleCancelAdd} />
            ) : selectedRecipient ? (
              <RecipientForm
                ...
                initialData={{
                  ...
                  country:
                    recipients.find((r) => r.id === selectedRecipient)?.country || 'United Kingdom',
              ...
              <div className="flex flex-col items-center justify-center h-full py-12">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6">
                  Select a recipient from the list or add a new one
                </p>
                <button
