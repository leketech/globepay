...
require (
	...
	golang.org/x/tools v0.23.0 // Downgrade to fix compatibility with Go 1.25
)
...
require (
	...
	go.uber.org/multierr v1.8.0 // indirect; Changed from v1.11.0 to v1.8.0 for Go 1.18 compatibility
